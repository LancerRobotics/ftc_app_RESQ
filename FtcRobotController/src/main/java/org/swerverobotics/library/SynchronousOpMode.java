...
import org.swerverobotics.library.interfaces.IInterruptableRunnable;
import org.swerverobotics.library.interfaces.IThunkDispatcher;
import org.swerverobotics.library.internal.IActionKeyed;
import org.swerverobotics.library.internal.SwerveThreadContext;
import org.swerverobotics.library.internal.ThunkingHardwareFactory;
...
public abstract class SynchronousOpMode extends OpMode implements IThunkDispatcher
    ...
    private static boolean gamepadsSame(Gamepad p1, Gamepad p2)
        {
    ...
    private static void gamepadAssign(Gamepad dst, Gamepad src)
        {
