...
public class ThunkedDCMotorController implements DcMotorController, IThunkedReadWriteListener, IThunkWrapper<DcMotorController>
    ...
    @Override public synchronized void setMotorChannelMode(final int channel, final RunMode mode)
        {
    ...
    @Override public synchronized RunMode getMotorChannelMode(final int channel)
        {
