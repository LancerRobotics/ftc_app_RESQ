...
public class ThunkedDeviceInterfaceModule implements DeviceInterfaceModule, IThunkWrapper<DeviceInterfaceModule>
    ...
    @Override public Mode getDigitalChannelMode(final int physicalPort)
        {
    ...
    @Override public void setDigitalChannelMode(final int physicalPort, final Mode mode)
        {
        (new ThunkForWriting()
            {
            @Override protected void actionOnLoopThread()
    ...
    @Override public void registerForI2cPortReadyCallback(final I2cPortReadyCallback callback, final int physicalPort)
        {
        (new ThunkForWriting()
            {
            @Override protected void actionOnLoopThread()
