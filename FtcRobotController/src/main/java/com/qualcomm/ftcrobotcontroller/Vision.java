...
public class VisionProcess {
    ...
    public Beacon output(Context context) {
        ...
        Bitmap CBG = Vision.toGrayscaleBitmap(Vision.filterRedBlue(Vision.fastblur(Vision.applyContrastBrightnessFilter(original, Vision.CONTRAST_ADJUSTMENT,Vision.BRIGHTNESS_ADJUSTMENT),2)));
        Log.e("contrast","done");
        Log.e("gray","done");
        Log.e("blur","done");
        Vision.savePicture(CBG,context,"CBG",false);
        //Bitmap RedBlue = Vision.filterRedBlue(CBG);
        //Vision.savePicture(RedBlue,context,"RedBlue",false);
